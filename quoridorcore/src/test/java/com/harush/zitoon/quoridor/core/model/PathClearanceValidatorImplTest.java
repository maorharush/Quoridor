...
public class PathClearanceValidatorImplTest {
    ...
    @Test
    public void getPathClearanceValidatorImplTest_Failed() {
        ...
        Assert.assertFalse(pathClearanceValidator.isPathClearToVictory(board, player,validMovesList));
    ...
    public void getPathClearanceValidatorImplTest_success(){
        ...
        WallData wallPlacement7 = new WallData(3, 0, false, true, null);
        WallData wallPlacement8 = new WallData(3, 1, false, false, null);
        List<WallData> wallPlacements = Lists.newArrayList(wallPlacement1, wallPlacement2, wallPlacement3, wallPlacement4, wallPlacement6, wallPlacement7, wallPlacement8);
        for (WallData wall : wallPlacements) {
            board.setWall(wall);
        }
