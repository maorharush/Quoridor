import com.harush.zitoon.quoridor.core.theirs.Validator;
...
public class ProvidedTests {
    ...
    void checkValid() {
        int n = moves.size();
        List<String> testMoves = new ArrayList<>(n + 1);
        ...
        Assert.assertFalse("Invalid: " + testMoves, validator.check(testMoves));
    }
